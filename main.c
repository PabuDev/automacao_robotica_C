 ...
 * ===================================================================
 * A robô Luzita vai andar pelo mapa usando duas "memórias" próprias com base em duas matrizes,
 * percorrendo as casa sem conhecê-las previamente.
 *
 *  - Memória Frontal (mapaMemoriaFrontalRobo): guarda o que a Luzita
 ...
 *      não seja a casa de onde ele acabou de vir e não tenha sido
